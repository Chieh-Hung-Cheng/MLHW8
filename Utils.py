...
class Utils:
    ...
    def initialize_time_path(local_flag=True):
        ...
        if local_flag:
            # Data path on local
            Config.data_path = r"D:\ML_Dataset\HW8"
        else:
            # Data path on Colab
    ...
    def fix_randomness():
        ...
        print(f"Randomness Fixed to seed {Config.seed}")

    @staticmethod
    def initialization(local_flag=True):
        Utils.initialize_time_path(local_flag=local_flag)
